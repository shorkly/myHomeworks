...
function initMap() {
  ...
  var map = L.map('map').setView([40.714662068404415, -74.00633391567929], 10);
  L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
  }).addTo(map);
  L.marker([40.714662068404415, -74.00633391567929]).addTo(map).bindPopup('New York City, United States - 1776 feet').openPopup();
  L.marker([22.324082975181533, 114.16888776904187]).addTo(map).bindPopup('Hong Kong - 1588 Feet');
} //плавный скролл
...
var lazyLoadInstance = new LazyLoad(); //активное меню
